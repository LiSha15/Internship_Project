...
if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])){
    ...
    $sql = "Select * from dealers where dealer_id='$username' and password='$password'";
            ...
            <div class="screen__content">
                <form action="admin_login.php" class="login" method="POST">
                    ...
                    <div class="login__field">
                        ...
                        <input type="text" class="login__input" placeholder="dealer id" name="dealer_id" id="dealer_id" >
                    </div>
                    <div class="login__field">
